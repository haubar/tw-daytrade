...
export const sampleScanResult = {
  ...
  longWatchlist: [
    {
      code: '2408', name: '南亞科', market: 'TWSE', close: 445.5, changePercent: 10.62,
    ...
    {
      code: '3037', name: '欣興', market: 'TWSE', close: 168.0, changePercent: 7.35,
    ...
    {
      code: '6488', name: '環球晶', market: 'TWSE', close: 512.0, changePercent: 6.02,
    ...
    {
      code: '5347', name: '世界', market: 'TPEx', close: 158.5, changePercent: 5.15,
    ...
    {
      code: '3231', name: '緯創', market: 'TWSE', close: 112.0, changePercent: 4.28,
  ...
  shortWatchlist: [
    {
      code: '3661', name: '世芯-KY', market: 'TWSE', close: 2680.0, changePercent: -8.84,
    ...
    {
      code: '8069', name: '元太', market: 'TPEx', close: 186.0, changePercent: -6.98,
    ...
    {
      code: '6669', name: '緯穎', market: 'TWSE', close: 2210.0, changePercent: -5.44,
    ...
    {
      code: '2454', name: '聯發科', market: 'TWSE', close: 3850.0, changePercent: -4.2,
    ...
    {
      code: '3596', name: '智易', market: 'TPEx', close: 45.6, changePercent: -3.1,

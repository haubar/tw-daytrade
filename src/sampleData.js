...
export const sampleScanResult = {
  ...
  dataSourceStatus: {
    ...
    dayTradeEligibility: 'ok（1023 檔上市股票今天可以現股當沖；上櫃股票暫無資料源，一律顯示未知）',
  },
  ...
  longWatchlist: [
    {
      ...
      volumeRatio: 4.8, gapPercent: 8.2, dayTradeEligible: true, relativeStrengthWindowDays: 5, relativeStrength: 9.8, institutionalRatio: 12.4, institutionalDataMissing: false,
    ...
    },
    {
      ...
      volumeRatio: 3.9, gapPercent: 5.1, dayTradeEligible: true, relativeStrengthWindowDays: 5, relativeStrength: 6.9, institutionalRatio: 8.1, institutionalDataMissing: false,
    ...
    },
    {
      ...
      volumeRatio: 3.2, gapPercent: 4.4, dayTradeEligible: true, relativeStrengthWindowDays: 5, relativeStrength: 5.5, institutionalRatio: 5.6, institutionalDataMissing: false,
    ...
    },
    {
      ...
      volumeRatio: 2.1, gapPercent: 2.2, dayTradeEligible: true, relativeStrengthWindowDays: 5, relativeStrength: 3.1, institutionalRatio: 2.0, institutionalDataMissing: false,
  ...
  shortWatchlist: [
    {
      ...
      volumeRatio: 4.1, gapPercent: -7.6, dayTradeEligible: true, relativeStrengthWindowDays: 5, relativeStrength: -9.2, institutionalRatio: -10.8, institutionalDataMissing: false,
    ...
    },
    {
      ...
      volumeRatio: 2.9, gapPercent: -4.1, dayTradeEligible: true, relativeStrengthWindowDays: 5, relativeStrength: -5.0, institutionalRatio: -4.9, institutionalDataMissing: false,
    ...
    },
    {
      ...
      volumeRatio: 2.3, gapPercent: -3.0, dayTradeEligible: true, relativeStrengthWindowDays: 5, relativeStrength: -3.6, institutionalRatio: -3.2, institutionalDataMissing: false,

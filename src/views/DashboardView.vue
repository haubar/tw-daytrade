...
import BackfillControlView from './BackfillControlView.vue';
...
const loadData = async () => {
  ...
  try {
    try {
      result.value = await fetchLatestScan();

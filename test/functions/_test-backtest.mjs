import { evaluateOpenToCloseLong, evaluateOpenToCloseShort } from '../../netlify/functions/lib/backtest.mjs';
import { getLatestBacktestResult, saveBacktestResult, getBacktestIndex, getBacktestResultByDate } from '../../netlify/functions/lib/backtest-storage.mjs';
